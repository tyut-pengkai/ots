...
public class SysProfileController extends BaseController {
    ...
    public R<AvatarVo> avatar(@RequestPart("avatarfile") MultipartFile avatarfile) throws IOException {
        if (!avatarfile.isEmpty()) {
            ...
            HlvrAttachment file = attachmentService.uploadAttachment(avatarfile);
            String avatar = file.getPath();
            boolean updateSuccess = DataPermissionHelper.ignore(() -> userService.updateUserAvatar(LoginHelper.getUserId(), file.getId()));
            if (updateSuccess) {
