...
public class SysConfigController extends BaseController {
    ...
    @SaCheckPermission("system:config:list")
    @GetMapping("/getdesclist")
    public R<List<SysConfigVo>> getdesclist(@RequestHeader(value = "Content-Language", required = false) String contentLanguage) {
        if ("zh_CN".equals(contentLanguage) || contentLanguage == null) {
            // 中文
            return R.ok(configService.getdescList("zh"));
        } else {
            // 英文
            return R.ok(configService.getdescList("en"));
        }
    }
