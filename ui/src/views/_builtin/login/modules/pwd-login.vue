...
<template>
  <div>
    <div class="mb-5px text-32px text-black font-600 dark:text-white">{{ $t('page.login.common.loginTitle') }}</div>
    <div class="pb-18px text-16px text-#858585">{{ $t('page.login.common.loginDesc') }}</div>
    <NForm
      ref="formRef"
      :model="model"
      :rules="rules"
