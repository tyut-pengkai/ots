<template>
    <div class="min-h-500px flex-col-stretch gap-16px overflow-hidden lt-sm:overflow-auto">
        <TrainingSearch v-model:model="searchParams" @reset="resetSearchParams" @search="getDataByPage"/>
        <NCard :title="$t('trainingOperationCard.title')" :bordered="false" size="small" class="sm:flex-1-hidden card-wrapper">
            <template #header-extra>
                <NSpace wrap justify="end" class="lt-sm:w-200px">
                    ...
                    <NButton size="small" ghost type="primary" @click="handleSopCardCopy" :disabled="!currentRow">
                        <template #icon>
                            <icon-material-symbols:content-copy-outline-rounded class="text-icon" />
                        </template>
                        {{ $t('trainingOperationCard.copy') }}
                    </NButton>
                ...
                <div class="content-wrap">
                    <div class="table-wrap">
                        ...
                        >
                                    ...
                                    <div class="stepTwo-content-wrap">
                                        <div class="stepTwo-table">
                                            ...
                                            >
                                                    ...
                                                    <template #default="scope">
                                                        <div class="stepThree-content-wrap">
                                                            ...
                                                            >
                                                                ...
                                                                <el-table-column prop="optContent" :label="$t('trainingOperationCard.operationContent')" align="center"/>
                                                                <el-table-column prop="optCommentary" :label="$t('trainingOperationCard.operationCommentary')" align="center" show-overflow-tooltip/>
                                                                <el-table-column prop="indexing" :label="$t('trainingOperationCard.sortOrder')" align="center" width="80" />
                                                                <el-table-column :label="$t('common.action')" align="center" width="200">
                                                                    <template #default="scope">
                                                                        ...
                                                                        <ButtonIcon
                                                                            ...
                                                                            :tooltipContent="$t('trainingOperationCard.copy')"
                                                                        ...
                                                                        <ButtonIcon
                                                                            ...
                                                                            :tooltipContent="$t('trainingOperationCard.insertUp')"
                                                                        ...
                                                                        <ButtonIcon
                                                                            ...
                                                                            :tooltipContent="$t('trainingOperationCard.insertDown')"
                                                ...
                                                <el-table-column type="index" :label="$t('common.index')" align="center" width="70" />
                                                <el-table-column prop="groupName" :label="$t('trainingOperationCard.stepName')" align="center"/>
                                                <el-table-column prop="groupContent" :label="$t('trainingOperationCard.stepContent')" align="center" show-overflow-tooltip/>
                                                <el-table-column prop="groupContentDetail" :label="$t('trainingOperationCard.executionStandard')" align="center" show-overflow-tooltip/>
                                                <el-table-column :label="$t('common.action')" align="center" width="180">
                                                    <template #default="scope">
                                                        ...
                                                        <ButtonIcon
                                                            ...
                                                            :tooltipContent="$t('trainingOperationCard.addOperationStep')"
                            ...
                            <el-table-column type="index" :label="$t('common.index')" align="center" width="70" />
                            <el-table-column prop="name" :label="$t('trainingOperationCard.cardName')" align="center"/>
                            <el-table-column prop="initialZB" :label="$t('trainingOperationCard.initialPosition')" align="center" width="320"/>
                            <el-table-column prop="createBy" :label="$t('trainingOperationCard.creator')" align="center" width="120"/>
                            <el-table-column prop="updateTime" :label="$t('trainingOperationCard.createTime')" align="center" width="180"/>
                            <el-table-column :label="$t('common.action')" align="center" width="180">
                                <template #default="scope">
                                    <!-- 新增步骤组 -->
                                    <ButtonIcon
        ...
        <n-modal v-model:show="showModal"
                 preset="card"
                 :title="$t('trainingOperationCard.copyCardTitle')"
                 isplay-directive="show"
                 class="w-600px"
        >
            <NForm ref="formRef" :model="sopCardModel" :rules="sopCardRules">
                <NFormItem :label="$t('trainingOperationCard.cardName')" path="name">
                    <NInput v-model:value="sopCardModel.name" :placeholder="$t('trainingOperationCard.inputPlaceholder')"/>
                </NFormItem>
            </NForm>
            <template #footer>
...
<script setup lang="ts">
    ...
    import TrainingSearch from './modules/training-search.vue';
    import {$t} from "@/locales";
    import StepOneOperateDrawer from "@/views/trainingoperationcard/modules/stepone-operate-drawer.vue";
    import {
        getSopCardList, getSopCardInfo, delSopCard, getSopCardStepGroupList, delSopCardStepGroup, getSopCardStepGroupInfo,
        getStepsByGroupId, delSopCardStepOpt, getSopCardStepOptInfo, addStepOne, sopCardCopy
    } from '@/service/api/business/trainingoperationcard';
    import ButtonIcon from '@/components/custom/button-icon.vue';
    import {NDivider} from "naive-ui";
    import {jsonClone} from "~/packages/utils/src/klona";
    import StepTwoOperateDrawer from "@/views/trainingoperationcard/modules/steptwo-operate-drawer.vue";
    import StepThreeOperateDrawer from "@/views/trainingoperationcard/modules/stepthree-operate-drawer.vue";
    ...
    const sopCardRules = {
        name: createRequiredRule($t('trainingOperationCard.cardNameRequired')),
        initialZB: createRequiredRule($t('trainingOperationCard.initialPositionRequired'))
    }
