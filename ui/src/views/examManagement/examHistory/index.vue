<script setup lang="tsx">
    ...
    import ExamHistorySearch from './modules/exam-history-search.vue';
    import ExamHistoryDrawer from './modules/exam-history-drawer.vue';
...
<template>
    <div class="min-h-500px flex-col-stretch gap-16px overflow-hidden lt-sm:overflow-auto">
        <ExamHistorySearch :dept-data="deptList" v-model:model="searchParams" @reset="resetSearchParams" @search="getDataByPage" />
