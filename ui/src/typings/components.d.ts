...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    'IconMaterialSymbols:contentCopyOutlineRounded': typeof import('~icons/material-symbols/content-copy-outline-rounded')['default']
...
declare global {
  ...
  const Editor: typeof import('./../components/Editor/index.vue')['default']
  ...
  const 'IconMaterialSymbols:arrowBackIosRounded': typeof import('~icons/material-symbols/arrow-back-ios-rounded')['default']
  const 'IconMaterialSymbols:arrowForwardIosRounded': typeof import('~icons/material-symbols/arrow-forward-ios-rounded')['default']
  const 'IconMaterialSymbols:contentCopyOutlineRounded': typeof import('~icons/material-symbols/content-copy-outline-rounded')['default']
