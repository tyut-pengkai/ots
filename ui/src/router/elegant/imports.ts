...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  business_element: () => import("@/views/business/element/index.vue"),
  demo_demo: () => import("@/views/demo/demo/index.vue"),
  demo_tree: () => import("@/views/demo/tree/index.vue"),
  evaluationoperationcard: () => import("@/views/evaluationoperationcard/index.vue"),
  exammanagement_examconfig: () => import("@/views/examManagement/examConfig/index.vue"),
  exammanagement_examhistory: () => import("@/views/examManagement/examHistory/index.vue"),
  ...
  resourcemanagement_file: () => import("@/views/resourceManagement/file/index.vue"),
  resourcemanagement_model: () => import("@/views/resourceManagement/model/index.vue"),
  ...
  trainingmanagement_trainingconfig: () => import("@/views/trainingManagement/trainingConfig/index.vue"),
  trainingmanagement_traininghistory: () => import("@/views/trainingManagement/trainingHistory/index.vue"),
  trainingoperationcard: () => import("@/views/trainingoperationcard/index.vue"),
  viewcontent: () => import("@/views/viewcontent/index.vue"),
  viewoverview: () => import("@/views/viewoverview/index.vue"),
  viewresource: () => import("@/views/viewresource/index.vue"),
  viewtopic: () => import("@/views/viewtopic/index.vue"),
};
