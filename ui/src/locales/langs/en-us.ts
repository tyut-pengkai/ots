const local: App.I18n.Schema = {
  ...
  route: {
    ...
    business_element: 'Asset Element Management',
    evaluationoperationcard: "Evaluation Operation Card Management",
    question: "Question Bank Management",
    resourcemanagement: "Resource Management",
    resourcemanagement_file: "File Resource",
    resourcemanagement_model: "Model Resource",
    trainingmanagement: "Training Management",
    trainingmanagement_trainingconfig: "Training Config",
    trainingmanagement_traininghistory: "Training Log",
    trainingoperationcard: "Training Operation Card Management",
    viewtopic: "",
  ...
  page: {
    login: {
      common: {
        title: 'Exceeding customer expectations and creating best practices',
        subTitle: 'Profound in Kindness, Profound in Morality,Profound in Knowledge, Profound in Practice, Profound in Steadiness.and Profound in Cultivation',
        loginOrRegister: 'Login / Register',
        register: 'Register',
        loginTitle: 'Login to your account',
        loginDesc: 'Welcome back! Please enter your account information',
      ...
      dict: {
        ...
        form: {
          ...
          attr: {
            ...
            invalid: 'Attribute cannot be empty'
          },
          dictLabel: {
  ...
  evaluationOperationCard: {
    title: 'Evaluation Operation Card Management',
    copyTrainCard: 'Copy Training Operation Card',
    copy: 'Copy',
    operationContent: 'Operation Content',
    operationCommentary: 'Operation Commentary',
    sortOrder: 'Sort Order',
    insertUp: 'Insert Up',
    insertDown: 'Insert Down',
    stepName: 'Step Name',
    stepContent: 'Step Content',
    executionStandard: 'Execution Standard/Precautions',
    addOperationStep: 'Add Operation Step',
    cardName: 'Card Name',
    initialPosition: 'Initial Position',
    creator: 'Creator',
    createTime: 'Create Time',
    copyExamCard: 'Copy Evaluation Operation Card',
    trainCard: 'Training Operation Card',
    inputPlaceholder: 'Please input',
    selectTrainCardRequired: 'Please select training operation card',
    cardNameRequired: 'Card name cannot be empty',
    initialPositionRequired: 'Initial position cannot be empty'
  },
  trainingOperationCard: {
    title: 'Training Operation Card Management',
    copy: 'Copy',
    operationContent: 'Operation Content',
    operationCommentary: 'Operation Commentary',
    sortOrder: 'Sort Order',
    ...
    creator: 'Creator',
    createTime: 'Create Time',
    copyCardTitle: 'Copy Training Operation Card',
