const local: App.I18n.Schema = {
  ...
  route: {
    ...
    exception_500: '500',
    business: '资产管理',
    business_element: '资产管理',
    evaluationoperationcard: "考核操作卡管理",
    question: "题库管理",
    resourcemanagement: "资源管理",
    resourcemanagement_file: "文件资源",
    resourcemanagement_model: "模型资源",
    trainingmanagement: "培训管理",
    trainingmanagement_trainingconfig: "培训配置",
    trainingmanagement_traininghistory: "培训记录",
    trainingoperationcard: "培训操作卡管理",
    viewtopic: "",
    examManagement: "考核管理"
  },
  menu: {
  ...
  page: {
    login: {
      common: {
        title: '超越客户期望 创造最佳实践',
        subTitle: '厚道·厚德·厚知·厚行·厚重·厚爱',
        loginOrRegister: '登录 / 注册',
        register: '注册',
        loginTitle: '登录到您的账户',
        loginDesc: '欢迎回来！请输入您的账户信息',
  ...
  evaluationOperationCard: {
    title: '考核操作卡管理',
    copyTrainCard: '复制培训操作卡',
    copy: '复制',
    operationContent: '操作内容',
    operationCommentary: '操作解说',
    sortOrder: '排序号',
    insertUp: '向上插入',
    insertDown: '向下插入',
    stepName: '步骤名称',
    stepContent: '步骤内容',
    executionStandard: '执行标准/注意事项',
    addOperationStep: '新增操作步骤',
    cardName: '操作卡名称',
    initialPosition: '初始位置',
    creator: '创建人',
    createTime: '创建时间',
    copyExamCard: '复制考核操作卡',
    trainCard: '培训操作卡',
    inputPlaceholder: '请输入',
    selectTrainCardRequired: '请选择培训操作卡',
    cardNameRequired: '操作卡名称不能为空',
    initialPositionRequired: '初始化坐标不能为空'
  },
